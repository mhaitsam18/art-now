                ...
                <div class="col-lg-12 card-form__body card-body">
                    ...
                    <form method="POST" id="form" action="<?= BASEURL . '/pengguna/kirim_pembayaran_dp/' . $data['id_pesanan']; ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" id="total_dibayar" value="Rp <?= number_format(2000000, 0, ",", ".") ?>" class="form-control" disabled/>
                        </div>
                        <div class="form-group">
                            <label for="total_terbilang">Terbilang:</label>
                            <input type="text" id="total_terbilang" value="<?= ucfirst(terbilang(2000000)) ?> rupiah" class="form-control" disabled/>
                        </div>
                        <div class="form-group">
